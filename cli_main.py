...
CONTEXT_SETTINGS = dict(help_option_names=['-h', '--help',"A Simplified Git automation tool for the lay developer, What are the commands can be used can be checked below"])
